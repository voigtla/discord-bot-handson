...
を先に言ってあげないと、**「難しそう」で止まる回**なんだよね。

なので、**説明を削らず・技術を隠さず・でも迷わせない**
第7回 README を「参加者目線」に書き直す。

以下は **そのまま `handson-guides/07_error-handling/README.md` に置ける完成版**。
